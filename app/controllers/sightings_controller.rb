class SightingsController < ApplicationController
  ...
  def new
    ...
    # @regions_for_select = Sighting.all.map do |sighting|
    #   [sighting.region, sighting.id]
    # end
    # @sighting.regions = 'West'
  end
  ...
  private
    ...
    def sighting_params
      params.require(:sighting).permit(:date, :lat, :long, :animal_id, :regions)
    end
end
